...
function ButtonGroupText({ className, asChild = false, ...props }) {
    ...
    return (_jsx(Comp, { className: cn("flex items-center gap-2 rounded-md border bg-muted px-2.5 text-sm font-medium shadow-xs [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4", className), ...props }));
}
